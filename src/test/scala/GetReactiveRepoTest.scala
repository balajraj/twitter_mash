...
class GetReactiveRepoTest extends FlatSpec with MockFactory {

  "The GetReactiveRepoTest " should "send out http request with no exceptions " in {
    val httpWrapper = mock[HttpWrapper]
    val reactive = new GetReactiveRepo(httpWrapper)
